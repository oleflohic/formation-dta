...
public class PizzeriaAdminConsoleApp {
	...
	protected static Pizza[] pizzas = new Pizza[] {
			Pizza.creerObjetPizza("PEP", "Peperoni", 10),
			Pizza.creerObjetPizza("MAR", "Margherita", 14),
			Pizza.creerObjetPizza("REI", "La Reine", 11.5),
			Pizza.creerObjetPizza("FRO", "La 4 fromages", 12),
			Pizza.creerObjetPizza("CAN", "La cannibale", 12.5),
			Pizza.creerObjetPizza("SAV", "La savoyarde", 13),
			Pizza.creerObjetPizza("ORI", "L'orientale", 13.5),
			Pizza.creerObjetPizza("IND", "L'indienne", 14),
		};
	...
	public static void ajouterPizza () {
		...
		if (!codePris) {
			...
			Pizza pizzaAjoutee = Pizza.creerObjetPizza(codePizzaAjoutee, nomPizzaAjoutee, prixPizzaAjoutee);
			...
			// sinon continuer les saisies
				...
				if (indexPizzaAMaj == -1) {
					...
					if (!codePris) {
						...
						pizzas[indexPizzaAMaj] = Pizza.creerObjetPizza(codePizzaApresMaj, nomPizzaApresMaj, prixPizzaApresMaj);
					}
